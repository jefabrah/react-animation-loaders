(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactAnimationLoaders"] = factory(require("react"));
	else
		root["ReactAnimationLoaders"] = factory(root["React"]);
...
var _enhancer = __webpack_require__(15);
...
var ConfiguredRadium = function ConfiguredRadium(component) {
  return (0, _radium2.default)({
    plugins: [_radium2.default.Plugins.keyframes, _radium2.default.Plugins.prefix, _radium2.default.Plugins.checkProps]
  })(component);
};
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(76), __webpack_require__(3)))
...
var _getStateKey = __webpack_require__(16);
...
var _AMCDotsDetail = __webpack_require__(27);

var _AMCDotsDetail2 = _interopRequireDefault(_AMCDotsDetail);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var AMCDots = function AMCDots(_ref) {
  ...
  var key = 'AMCDots' + duration + size;

  return loading ? _react2.default.createElement(
    _radium.StyleRoot,
    { key: key, style: { width: '100%', height: '100%' } },
    _react2.default.createElement(_AMCDotsDetail2.default, { loaderColor: loaderColor, backgroundColor: backgroundColor,
      duration: duration, size: size, isFixed: isFixed })
  ) : children;
};

exports.default = AMCDots;
module.exports = exports['default'];
...
var _BlottyDetail = __webpack_require__(28);

var _BlottyDetail2 = _interopRequireDefault(_BlottyDetail);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Blotty = function Blotty(_ref) {
  var loading = _ref.loading,
      children = _ref.children,
      duration = _ref.duration,
      size = _ref.size,
  ...
  var key = 'blotty' + duration + size;

  return loading ? _react2.default.createElement(
    _radium.StyleRoot,
    { key: key, style: { width: '100%', height: '100%' } },
    _react2.default.createElement(_BlottyDetail2.default, { loaderColor: loaderColor, backgroundColor: backgroundColor,
      duration: duration, size: size, isFixed: isFixed })
  ) : children;
};

exports.default = Blotty;
module.exports = exports['default'];
...
var _GSpinnerDetail = __webpack_require__(29);

var _GSpinnerDetail2 = _interopRequireDefault(_GSpinnerDetail);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var GSpinner = function GSpinner(_ref) {
  var loading = _ref.loading,
      children = _ref.children,
      duration = _ref.duration,
      size = _ref.size,
  ...
  var key = 'GSpinner' + duration + size;

  return loading ? _react2.default.createElement(
    _radium.StyleRoot,
    { key: key, style: { width: '100%', height: '100%' } },
    _react2.default.createElement(_GSpinnerDetail2.default, { loaderColor: loaderColor, backgroundColor: backgroundColor,
      duration: duration, size: size, isFixed: isFixed })
  ) : children;
};
...
var _PulseDetail = __webpack_require__(30);

var _PulseDetail2 = _interopRequireDefault(_PulseDetail);
...
var Pulse = function Pulse(_ref) {
  ...
  var key = 'pulse' + duration + size;

  return loading ? _react2.default.createElement(
    _radium.StyleRoot,
    { key: key, style: { width: '100%', height: '100%' } },
    _react2.default.createElement(_PulseDetail2.default, { loaderColor: loaderColor, backgroundColor: backgroundColor,
      duration: duration, size: size, isFixed: isFixed })
  ) : children;
};
...
var _ConfiguredRadium = __webpack_require__(4);
...
var AMCDotsDetail = function AMCDotsDetail(_ref) {
  ...
  // determine duration
  var animationDuration = duration ? duration : 1.5;
  ...
  var amcDotsKeyframes = _radium2.default.keyframes({
    '0%': { transform: 'scale(0)' },
    '30%': { transform: 'scale(1)' },
    '60%, 100%': { transform: 'scale(0)' }
  }, 'AMCDotPulse');

  var amcDotsBoxStyles = {
    height: '100%',
    width: '100%',
    display: 'flex',
  ...
  return _react2.default.createElement(
    'div',
    { style: amcDotsBoxStyles },
    _react2.default.createElement('div', { style: amcDotLeftStyles }),
    _react2.default.createElement('div', { style: amcDotCenterStyles }),
    _react2.default.createElement('div', { style: amcDotRightStyles })
  );
};

exports.default = (0, _ConfiguredRadium2.default)(AMCDotsDetail);
module.exports = exports['default'];
...
var Blotty = function Blotty(_ref) {
  ...
  var blotLRKeyframes = _radium2.default.keyframes({
    '25%, 75%': { transform: 'translateX(' + translateL + 'em) scale(0.75)' },
    '95%': { transform: 'translateX(0em) scale(1)' }
  }, 'BlotLR');

  var blotLLKeyframes = _radium2.default.keyframes({
    '25%, 75%': { transform: 'translateX(-' + translateL + 'em) scale(0.75)' },
    '95%': { transform: 'translateX(0em) scale(1)' }
  }, 'BlotLL');

  var blotMRKeyframes = _radium2.default.keyframes({
    '25%': { transform: 'translateX(' + translateL + 'em) scale(0.75)' },
    '50%, 75%': { transform: 'translateX(' + translateM + 'em) scale(0.6)' },
    '95%': { transform: 'translateX(0em) scale(1)' }
  }, 'BlotMR');

  var blotMLKeyframes = _radium2.default.keyframes({
    '25%': { transform: 'translateX(-' + translateL + 'em) scale(0.75)' },
    '50%, 75%': { transform: 'translateX(-' + translateM + 'em) scale(0.6)' },
    '95%': { transform: 'translateX(0em) scale(1)' }
  }, 'BlotML');

  var blotSRKeyframes = _radium2.default.keyframes({
    '25%': { transform: 'translateX(' + translateL + 'em) scale(0.75)' },
  ...
  var blotSLKeyframes = _radium2.default.keyframes({
    '25%': { transform: 'translateX(-' + translateL + 'em) scale(0.75)' },
    '50%': { transform: 'translateX(-' + translateM + 'em) scale(0.6)' },
    '75%': { transform: 'translateX(-' + translateS + 'em) scale(0.5)' },
    '95%': { transform: 'translateX(0em) scale(1)' }
  ...
  return _react2.default.createElement(
    'div',
    { style: blottyBoxStyles },
    _react2.default.createElement('div', { style: blottyLRStyles }),
    _react2.default.createElement('div', { style: blottyLLStyles }),
    _react2.default.createElement('div', { style: blottyMRStyles }),
    _react2.default.createElement('div', { style: blottyMLStyles }),
    _react2.default.createElement('div', { style: blottySRStyles }),
    _react2.default.createElement('div', { style: blottySLStyles })
  );
};

exports.default = (0, _ConfiguredRadium2.default)(Blotty);
module.exports = exports['default'];
...
var GSpinnerDetail = function GSpinnerDetail(_ref) {
  var duration = _ref.duration,
      size = _ref.size,
      loaderColor = _ref.loaderColor,
      backgroundColor = _ref.backgroundColor,
  ...
  // determine duration
  var animationDuration = duration ? duration : 4;
  ...
  var translationHeight = loaderSize * 2;

  // ANIMATIONS
  var gSpinnerBoxRotate = _radium2.default.keyframes({
    from: { transform: 'rotate(0deg)' },
    to: { transform: 'rotate(360deg)' }
  }, 'gSpinnerBoxRotate');

  var gSpinnerC1Animation = _radium2.default.keyframes({
    '0%': {
  ...
  var gSpinnerC2Animation = _radium2.default.keyframes({
    '0%': {
      background: colors.loaderColor,
  ...
  var gSpinnerC3Animation = _radium2.default.keyframes({
    '0%': {
      background: colors.loaderColor,
      transform: 'translateY(' + translationHeight + 'px)'
    },
  ...
  var gSpinnerC4Animation = _radium2.default.keyframes({
    '0%': {
      background: colors.loaderColor,
      transform: 'translateX(' + translationHeight + 'px)'
    },
  ...
  return _react2.default.createElement(
    'div',
    { style: gSpinnerWrapperStyles },
    _react2.default.createElement(
      'div',
      { style: gSpinnerBoxStyles },
      _react2.default.createElement('div', { style: gSpinnerC1 }),
      _react2.default.createElement('div', { style: gSpinnerC2 }),
      _react2.default.createElement('div', { style: gSpinnerC3 }),
      _react2.default.createElement('div', { style: gSpinnerC4 })
    )
  );
};

exports.default = (0, _ConfiguredRadium2.default)(GSpinnerDetail);
module.exports = exports['default'];
...
var PulseDetail = function PulseDetail(_ref) {
  var duration = _ref.duration,
      size = _ref.size,
      loaderColor = _ref.loaderColor,
      backgroundColor = _ref.backgroundColor,
  ...
  // determine duration
  var animationDuration = duration ? duration : 0.75;

  // determine size
  var pulseWidth = 12.5;
  var centerPulseHeight = 50;
  var sidePulseHeight = 33.3;
  var sidePulseMargin = 10;
  ...
  var pulseKeyframes = _radium2.default.keyframes({
  ...
  return _react2.default.createElement(
    'div',
    { style: pulseBoxStyles },
    _react2.default.createElement('div', { style: pulseLeftStyles }),
    _react2.default.createElement('div', { style: pulseCenterStyles }),
    _react2.default.createElement('div', { style: pulseRightStyles })
  );
};

exports.default = (0, _ConfiguredRadium2.default)(PulseDetail);
module.exports = exports['default'];
...
exports.AMCDots = exports.Pulse = exports.GSpinner = exports.Blotty = undefined;

var _Blotty = __webpack_require__(24);

var _Blotty2 = _interopRequireDefault(_Blotty);

var _GSpinner = __webpack_require__(25);

var _GSpinner2 = _interopRequireDefault(_GSpinner);

var _Pulse = __webpack_require__(26);

var _Pulse2 = _interopRequireDefault(_Pulse);

var _AMCDots = __webpack_require__(23);

var _AMCDots2 = _interopRequireDefault(_AMCDots);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.Blotty = _Blotty2.default;
exports.GSpinner = _GSpinner2.default;
exports.Pulse = _Pulse2.default;
exports.AMCDots = _AMCDots2.default;
...
!function (root, name, definition) {
  if (typeof module != 'undefined' && module.exports) module.exports = definition();else if (true) __webpack_require__(77)(name, definition);else root[name] = definition();
...
var _prefixAll2 = __webpack_require__(55);

var _prefixAll3 = _interopRequireDefault(_prefixAll2);

var _getBrowserInformation = __webpack_require__(56);

var _getBrowserInformation2 = _interopRequireDefault(_getBrowserInformation);

var _getPrefixedKeyframes = __webpack_require__(57);
...
var _zoomCursor = __webpack_require__(44);
...
var _flex = __webpack_require__(36);
...
var _flexboxIE = __webpack_require__(37);
...
var _hyphenateStyleName = __webpack_require__(11);

var _hyphenateStyleName2 = _interopRequireDefault(_hyphenateStyleName);

var _unprefixProperty = __webpack_require__(59);
...
var _joinPrefixedValue = __webpack_require__(5);
...
var _prefixProps = __webpack_require__(12);
...
var _position = __webpack_require__(52);
...
var _flex = __webpack_require__(48);

var _flex2 = _interopRequireDefault(_flex);

var _sizing = __webpack_require__(53);
...
var _flexboxIE = __webpack_require__(49);
